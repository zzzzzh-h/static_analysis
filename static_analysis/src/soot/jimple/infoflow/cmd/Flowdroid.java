    ...
    private ArrayList<InfoflowResults> run(String[] args) throws Exception {
        ...
        try {
            ...
            for (File apkFile : apksToAnalyze) {
                ...
                //自己加的↓
                analyzer.getConfig().setDataFlowTimeout(300);
                analyzer.getConfig().getCallbackConfig().setCallbackAnalysisTimeout(300);
                analyzer.getConfig().getOutputConfiguration().setResultSerializationTimeout(300);
                //自己加的↑
